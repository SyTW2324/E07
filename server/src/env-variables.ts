...
export const uri_bbdd: string = 'mongodb+srv://adminProyecto:XrGAiCeGbROwlsPv@cluster0.opw3djq.mongodb.net/sientatealamesa2';

export const uri_bbdd_test: string = 'mongodb+srv://adminProyecto:XrGAiCeGbROwlsPv@cluster0.opw3djq.mongodb.net/sientatealamesa-test';
...
export const uri_bbdd_dev: string = 'mongodb+srv://adminProyecto:XrGAiCeGbROwlsPv@cluster0.opw3djq.mongodb.net/sientatealamesa-dev2';
