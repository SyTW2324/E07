...
export const uri_bbdd: string = 'mongodb+srv://adminProyecto:XrGAiCeGbROwlsPv@cluster0.opw3djq.mongodb.net/sientatealamesa';
...
export const uri_bbdd_dev: string = 'mongodb+srv://adminProyecto:XrGAiCeGbROwlsPv@cluster0.opw3djq.mongodb.net/sientatealamesa-dev';
